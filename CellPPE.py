...
class CellPPE(Architecture):
    ...
    def __init__(self):
        super().__init__()
        self.ppc = Architecture['ppc64']

    def get_instruction_info(self, data, addr):
        return self.ppc.get_instruction_info(data, addr)

    def get_instruction_text(self, data, addr):
        return self.ppc.get_instruction_text(data, addr)

    def get_instruction_low_level_il(self, data, addr, il):
        return self.ppc.get_instruction_low_level_il(data, addr, il)